...
pub mod fp {
    ...
    pub fn test_fp_multiplication(c: &mut Criterion) {
        c.bench_function("test_fp_multiplication", |b| b.iter(|| A * B));
    }
    pub fn test_fp_addition(c: &mut Criterion) {
        c.bench_function("test_fp_addition", |b| b.iter(|| A + B));
    }
    pub fn test_fp_subtraction(c: &mut Criterion) {
        c.bench_function("test_fp_subtraction", |b| b.iter(|| A - B));
    }
    pub fn test_fp_division(c: &mut Criterion) {
        c.bench_function("test_fp_division", |b| b.iter(|| A / B));
    }
    pub fn test_fp_random(c: &mut Criterion) {
        c.bench_function("test_fp_random", |b| {
            b.iter(|| <Fp as FieldExtensionTrait<1, 1>>::rand(&mut OsRng))
        });
    }
...
pub mod fp2 {
    ...
    pub fn test_fp2_multiplication(c: &mut Criterion) {
        c.bench_function("test_fp2_multiplication", |b| b.iter(|| A * B));
    }
    pub fn test_fp2_addition(c: &mut Criterion) {
        c.bench_function("test_fp2_addition", |b| b.iter(|| A + B));
    }
    pub fn test_fp2_subtraction(c: &mut Criterion) {
        c.bench_function("test_fp2_subtraction", |b| b.iter(|| A - B));
    }
    pub fn test_fp2_division(c: &mut Criterion) {
        c.bench_function("test_fp2_division", |b| b.iter(|| A / B));
    }
    pub fn test_fp2_random(c: &mut Criterion) {
        c.bench_function("test_fp2_random", |b| {
            b.iter(|| <Fp2 as FieldExtensionTrait<2, 2>>::rand(&mut OsRng))
        });
    }
...
pub mod fp6 {
    ...
    pub fn test_fp6_multiplication(c: &mut Criterion) {
        c.bench_function("test_fp6_multiplication", |b| b.iter(|| A * B));
    }
    pub fn test_fp6_addition(c: &mut Criterion) {
        c.bench_function("test_fp6_addition", |b| b.iter(|| A + B));
    }
    pub fn test_fp6_subtraction(c: &mut Criterion) {
        c.bench_function("test_fp6_subtraction", |b| b.iter(|| A - B));
    }
    pub fn test_fp6_division(c: &mut Criterion) {
        c.bench_function("test_fp6_division", |b| b.iter(|| A / B));
    }
    pub fn test_fp6_random(c: &mut Criterion) {
        c.bench_function("test_fp6_random", |b| {
            b.iter(|| <Fp6 as FieldExtensionTrait<6, 3>>::rand(&mut OsRng))
        });
    }
...
pub mod fp12 {
    ...
    pub fn test_fp12_multiplication(c: &mut Criterion) {
        c.bench_function("test_fp12_multiplication", |b| b.iter(|| A * B));
    }
    pub fn test_fp12_addition(c: &mut Criterion) {
        c.bench_function("test_fp12_addition", |b| b.iter(|| A + B));
    }
    pub fn test_fp12_subtraction(c: &mut Criterion) {
        c.bench_function("test_fp12_subtraction", |b| b.iter(|| A - B));
    }
    pub fn test_fp12_division(c: &mut Criterion) {
        c.bench_function("test_fp12_division", |b| b.iter(|| A / B));
    }
    pub fn test_fp12_random(c: &mut Criterion) {
        c.bench_function("test_fp12_random", |b| b.iter(|| Fp12::rand(&mut OsRng)));
    }
